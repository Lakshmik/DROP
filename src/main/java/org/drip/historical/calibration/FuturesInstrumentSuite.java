...
/**
 * <i>FuturesInstrumentSuite</i> contains the Configuration Settings to generate the Futures Calibration
 * 	Suite. It provides the following Functionality:
 *
 *  <ul>
 * 		<li><i>FuturesInstrumentSuite</i> Constructor</li>
...
public class FuturesInstrumentSuite
	extends InstrumentSuite
{
	private int _componentCount = -1;

	/**
	 * <i>FuturesInstrumentSuite</i> Constructor
	 * 
	 * @param code Deposit Code
	 * @param currency Currency
	 * @param calibrationMetric Deposit Calibration Metric
	 * @param componentCount Number of Caliration Components
	 * 
	 * @throws Exception Thrown if the Inputs are Invalid
	 */

	public FuturesInstrumentSuite (
		final String code,
