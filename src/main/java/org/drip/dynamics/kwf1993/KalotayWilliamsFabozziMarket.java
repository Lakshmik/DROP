...
/**
 * <i>KalotayWilliamsFabozziMarket</i> holds the Market Inputs used for calibrating the Kalotay, Williams,
 * 	and Fabozzi (1993) Tree. The References are:
 *  
 * 	<br>
 *  <ul>
 * 		<li>
...
public class KalotayWilliamsFabozziMarket
{
	private double _annualizedForwardYieldVolatility = Double.NaN;
	private TreeMap<Double, Double> _timeCalibrationYieldMap = null;

	/**
	 * <i>KalotayWilliamsFabozziMarket</i> Constructor
	 * 
	 * @param timeCalibrationYieldMap Time Map of Calibration Yield
	 * @param annualizedForwardYieldVolatility Annualized Forward Yield Volatility
	 * 
	 * @throws Exception Thrown if the Inputs are Invalid
	 */

	public KalotayWilliamsFabozziMarket (
		final TreeMap<Double, Double> timeCalibrationYieldMap,
		final double annualizedForwardYieldVolatility)
		throws Exception
	{
		if (null == (_timeCalibrationYieldMap = timeCalibrationYieldMap) ||
				0 == timeCalibrationYieldMap.size() ||
			!NumberUtil.IsValid (_annualizedForwardYieldVolatility = annualizedForwardYieldVolatility) ||
				0. > _annualizedForwardYieldVolatility)
		{
			throw new Exception ("KalotayWilliamsFabozziMarket Constructor => Invalid Inputs");
		}
	}

	/**
	 * Retrieve the Time Map of Calibration Yield
	 * 
	 * @return Time Map of Calibration Yield
	 */

	public TreeMap<Double, Double> timeCalibrationYieldMap()
	{
		return _timeCalibrationYieldMap;
	}
	...
	public String toString (
		final String prefix)
	{
		return prefix + "Time Calibration Yield Map => " + _timeCalibrationYieldMap +
			"; Annualized Forward Yield Volatility => " +
				FormatUtil.FormatDouble (_annualizedForwardYieldVolatility, 2, 5, 1.);
	}
