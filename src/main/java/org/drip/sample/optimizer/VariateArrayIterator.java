...
/**
 * <i>VariateArrayIterator</i> illustrates the Construction and Usage of the Exhaustive Variate Array
 * 	Iterator. The References are:
 *
 *  <br>
 *  <ul>
 *  	<li>
...
public class VariateArrayIterator
{
		...
		throws Exception
	{
		...
		System.out.println ("\t||" + NumberUtil.ArrayRow (variateIndexArray, 1, false) + " ||");

		while (null != (variateIndexArray = sequenceIndexIterator.next())) {
			System.out.println ("\t||" + NumberUtil.ArrayRow (variateIndexArray, 1, false) + " ||");
		}
