...
public class EfficientFrontierWithDrift
{
		...
		throws Exception
	{
		...
		for (double lambdaShortEndU : lambdaShortEndUArray) {
			...
			double transactionCostExpectation = almgrenChrissDriftDiscrete.transactionCostExpectation();

			double transactionCostVariance = almgrenChrissDriftDiscrete.transactionCostVariance();
			...
			System.out.println (
				"\t| [LAMBDA = " + FormatUtil.FormatDouble (
					...
					transactionCostExpectation * inverseX,
					1,
					4,
					1.
				) + " | " + FormatUtil.FormatDouble (
					transactionCostVariance * inverseX * inverseX,
					1,
					4,
					1.
				) + " | " + FormatUtil.FormatDouble (
					transactionCostExpectation + lambdaShortEndU * transactionCostVariance * inverseX,
					1,
					4,
					1.
				) + " | " + FormatUtil.FormatDouble (
					almgrenChrissDriftDiscrete.halfLife(),
					2,
					2,
					1.
				) + "   ||"
		...
		for (double lambdaLongEndU : lambdaLongEndUArray) {
			...
			System.out.println (
				"\t| [LAMBDA = " + FormatUtil.FormatDouble (
					...
					transactionCostExpectation + lambdaLongEndU * transactionCostVariance * inverseX,
					1,
					4,
					1.
				) + " | " + FormatUtil.FormatDouble (
