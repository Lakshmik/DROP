...
public class FloatFloatMetricComparison
{
	...
	private static final double FloatFloatCMSParSpread (
		final String currency,
		final String cmsFloaterTenor,
		final String cmsMaturityTenor,
		final boolean inArrears,
		final JulianDate spotDate,
		final CurveSurfaceQuoteContainer curveSurfaceQuoteContainer)
		throws Exception
	{
		return MakeFloatFloatSwap (
			spotDate,
			currency,
			cmsFloaterTenor,
			cmsMaturityTenor,
		...
		throws Exception
	{
		...
		String currency = "USD";
		String[] cmsFloaterTenorArray =
		{
			"3M",
			"6M",
			"12M"
		};
		String[] cmsMaturityTenorArray =
		{
			"24M",
			"60M",
			"10Y",
		...
		for (String cmsMaturityTenor : cmsMaturityTenorArray) {
			String dump = "\t|     " + cmsMaturityTenor + "    |  ";

			for (String cmsFloaterTenor : cmsFloaterTenorArray) {
				dump += FormatUtil.FormatDouble (
					FloatFloatCMSParSpread (
						currency,
						cmsFloaterTenor,
						cmsMaturityTenor,
						false,
		...
		for (String cmsMaturityTenor : cmsMaturityTenorArray) {
			...
			for (String strCMSFloaterTenor : cmsFloaterTenorArray) {
				dump += FormatUtil.FormatDouble (
					FloatFloatCMSParSpread (
						currency,
						strCMSFloaterTenor,
