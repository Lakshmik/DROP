...
/**
 * <i>FundingMarkSuite</i> maintains the Instrument Market Quotes used in the Funding State Construction. It
 * 	provides the following Functionality:
 *
 *  <ul>
 * 		<li><i>FundingMarkSuite</i> Constructor</li>
 * 		<li>Retrieve the As Of Date</li>
 * 		<li>Retrieve the Array of Deposit Quotes</li>
 * 		<li>Retrieve the Array of Futures Quotes</li>
 * 		<li>Retrieve the Array of Fix-Float Quotes</li>
 *  </ul>
 *  
 *	<br>
...
public class FundingMarkSuite
{
	...
	public FundingMarkSuite (
		...
		throws Exception
	{
		if (null == (_asOfDate = asOfDate)) {
			throw new Exception ("FundingMarkSuite Constructor => Invalid Inputs");
		}
		...
		if ((null == _depositQuoteArray || 0 == _depositQuoteArray.length) &&
			(null == _futuresQuoteArray || 0 == _futuresQuoteArray.length) &&
			(null == _fixFloatQuoteArray || 0 == _fixFloatQuoteArray.length))
		{
			throw new Exception ("FundingMarkSuite Constructor => Invalid Inputs");
		}
	}
	...
	public JulianDate asOfDate()
	{
		return _asOfDate;
	}

	/**
	 * Retrieve the Array of Deposit Quotes
	 * 
	 * @return Array of Deposit Quotes
	 */

	public double[] depositQuoteArray()
	{
		return _depositQuoteArray;
	}

	/**
	 * Retrieve the Array of Futures Quotes
	 * 
	 * @return Array of Futures Quotes
	 */

	public double[] futuresQuoteArray()
	{
		return _futuresQuoteArray;
	}

	/**
	 * Retrieve the Array of Fix-Float Quotes
	 * 
	 * @return Array of Fix-Float Quotes
	 */

	public double[] fixFloatQuoteArray()
	{
