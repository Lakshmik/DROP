...
public class UncollateralizedFundingPayableStochastic
{
	...
	private static final double[] NumeraireValueRealization (
		...
		final double initialNumeraireValueInitial,
		final double time,
		...
		throws Exception
	{
		...
		numeraireValueArray[0] = initialNumeraireValueInitial;
		...
		JumpDiffusionEdge[] jumpDiffusionEdgeArray = numeraireValueDiffusionEvolver.incrementSequence (
			new JumpDiffusionVertex (time, initialNumeraireValueInitial, 0., false),
		...
		throws Exception
	{
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			double[] counterPartyRecoveryRate = NumeraireValueRealization (
