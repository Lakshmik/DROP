...
/**
 * <i>Himmelblau</i> implements the Multi-modal Himmelblau Function. The References are:
 *
 *  <br>
 *  <ul>
 *  	<li>
...
public class Himmelblau implements R2ToR1
{

	/**
	 * Empty <i>Himmelblau</i> Constructor
	 */
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (x) || !NumberUtil.IsValid (y)) {
			throw new Exception ("Himmelblau::evaluate => Invalid Inputs");
		}
