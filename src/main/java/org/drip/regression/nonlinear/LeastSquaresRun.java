...
/**
 * <i>LeastSquaresRun</i> holds the Results of a Least-Squares Estimation Run. The References are:
 *
 *  <br><br>
 *  <ul>
 *  	<li>
...
public class LeastSquaresRun
{
	private double[] _parameterArray = null;
	private double _sumOfResidualSquares = Double.NaN;

	/**
	 * Standard Instance of <i>LeastSquaresRun</i>
	 * 
	 * @param parameterArray Array of the Calibrated Parameters
	 * @param sumOfResidualSquares Sum of the Residual Squares
	 * 
	 * @return Standard Instance of <i>LeastSquaresRun</i>
	 */

	public static final LeastSquaresRun Standard (
		final double[] parameterArray,
		final double sumOfResidualSquares)
	{
		LeastSquaresRun leastSquaresRun = new LeastSquaresRun();

		return leastSquaresRun.setParameterArray (parameterArray) &&
			leastSquaresRun.setSumOfResidualSquares (sumOfResidualSquares) ? leastSquaresRun : null;
	}

	protected LeastSquaresRun()
	{
	}
	...
	/**
	 * Retrieve the Array of the Calibrated Parameters
	 * 
	 * @return Array of the Calibrated Parameters
	 */
	...
	/**
	 * Set the Sum of the Residual Squares
	 * 
	 * @param sumOfResidualSquares Sum of the Residual Squares
	 * 
	 * @return TRUE - The Sum of the Residual Squares Successfully Set
	 */
	...
	/**
	 * Retrieve the Sum of the Residual Squares
	 * 
	...
	/**
	 * Indicate if the Run is Successfully done
	 * 
	 * @return TRUE - Run is Successfully done
	 */

	public boolean isDone()
	{
		return null != _parameterArray && NumberUtil.IsValid (_parameterArray) &&
			NumberUtil.IsValid (_sumOfResidualSquares);
	}
