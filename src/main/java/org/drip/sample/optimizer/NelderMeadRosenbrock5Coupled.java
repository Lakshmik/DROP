...
/**
 * <i>NelderMeadRosenbrock5Coupled</i> illustrates the Optimization of Multidimensional Five Coupled 2D
...
public class NelderMeadRosenbrock5Coupled
{
		...
		throws Exception
	{
		...
		vertexList.add (new double[] {-2., -2., -2., -2., -2.});

		vertexList.add (new double[] {-2., -2., -2., -2.,  3.});

		vertexList.add (new double[] {-2., -2., -2.,  3., -2.});

		vertexList.add (new double[] {-2., -2., -2.,  3.,  3.});

		vertexList.add (new double[] {-2., -2.,  3., -2., -2.});

		vertexList.add (new double[] {-2., -2.,  3., -2.,  3.});

		vertexList.add (new double[] {-2., -2.,  3.,  3., -2.});

		vertexList.add (new double[] {-2., -2.,  3.,  3.,  3.});

		vertexList.add (new double[] {-2.,  3., -2., -2., -2.});

		vertexList.add (new double[] {-2.,  3., -2., -2.,  3.});

		vertexList.add (new double[] {-2.,  3., -2.,  3., -2.});

		vertexList.add (new double[] {-2.,  3., -2.,  3.,  3.});

		vertexList.add (new double[] {-2.,  3.,  3., -2., -2.});

		vertexList.add (new double[] {-2.,  3.,  3., -2.,  3.});

		vertexList.add (new double[] {-2.,  3.,  3.,  3., -2.});

		vertexList.add (new double[] {-2.,  3.,  3.,  3.,  3.});

		vertexList.add (new double[] { 3., -2., -2., -2., -2.});

		vertexList.add (new double[] { 3., -2., -2., -2.,  3.});

		vertexList.add (new double[] { 3., -2., -2.,  3., -2.});

		vertexList.add (new double[] { 3., -2., -2.,  3.,  3.});

		vertexList.add (new double[] { 3., -2.,  3., -2., -2.});

		vertexList.add (new double[] { 3., -2.,  3., -2.,  3.});

		vertexList.add (new double[] { 3., -2.,  3.,  3., -2.});

		vertexList.add (new double[] { 3., -2.,  3.,  3.,  3.});

		vertexList.add (new double[] { 3.,  3., -2., -2., -2.});

		vertexList.add (new double[] { 3.,  3., -2., -2.,  3.});

		vertexList.add (new double[] { 3.,  3., -2.,  3., -2.});

		vertexList.add (new double[] { 3.,  3., -2.,  3.,  3.});

		vertexList.add (new double[] { 3.,  3.,  3., -2., -2.});

		vertexList.add (new double[] { 3.,  3.,  3., -2.,  3.});

		vertexList.add (new double[] { 3.,  3.,  3.,  3., -2.});

		vertexList.add (new double[] { 3.,  3.,  3.,  3.,  3.});

		RdToR1 optimizationFunction = new MultidimensionalRosenbrockCoupled (Rosenbrock.Standard(), 5);
