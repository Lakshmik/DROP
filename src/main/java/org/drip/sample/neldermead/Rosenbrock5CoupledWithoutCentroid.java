...
/**
 * <i>Rosenbrock5CoupledWithoutCentroid</i> illustrates the Optimization of Multidimensional Three Coupled 2D
...
public class Rosenbrock5CoupledWithoutCentroid
{
		...
		throws Exception
	{
		...
		SetVertex (vertexList, -2., -2., -2., -2., -2.);

		SetVertex (vertexList, -2., -2., -2., -2.,  3.);

		SetVertex (vertexList, -2., -2., -2.,  3., -2.);

		SetVertex (vertexList, -2., -2., -2.,  3.,  3.);

		SetVertex (vertexList, -2., -2.,  3., -2., -2.);

		SetVertex (vertexList, -2., -2.,  3., -2.,  3.);

		SetVertex (vertexList, -2., -2.,  3.,  3., -2.);

		SetVertex (vertexList, -2., -2.,  3.,  3.,  3.);

		SetVertex (vertexList, -2.,  3., -2., -2., -2.);

		SetVertex (vertexList, -2.,  3., -2., -2.,  3.);

		SetVertex (vertexList, -2.,  3., -2.,  3., -2.);

		SetVertex (vertexList, -2.,  3., -2.,  3.,  3.);

		SetVertex (vertexList, -2.,  3.,  3., -2., -2.);

		SetVertex (vertexList, -2.,  3.,  3., -2.,  3.);

		SetVertex (vertexList, -2.,  3.,  3.,  3., -2.);

		SetVertex (vertexList, -2.,  3.,  3.,  3.,  3.);

		SetVertex (vertexList,  3., -2., -2., -2., -2.);

		SetVertex (vertexList,  3., -2., -2., -2.,  3.);

		SetVertex (vertexList,  3., -2., -2.,  3., -2.);

		SetVertex (vertexList,  3., -2., -2.,  3.,  3.);

		SetVertex (vertexList,  3., -2.,  3., -2., -2.);

		SetVertex (vertexList,  3., -2.,  3., -2.,  3.);

		SetVertex (vertexList,  3., -2.,  3.,  3., -2.);

		SetVertex (vertexList,  3., -2.,  3.,  3.,  3.);

		SetVertex (vertexList,  3.,  3., -2., -2., -2.);

		SetVertex (vertexList,  3.,  3., -2., -2.,  3.);

		SetVertex (vertexList,  3.,  3., -2.,  3., -2.);

		SetVertex (vertexList,  3.,  3., -2.,  3.,  3.);

		SetVertex (vertexList,  3.,  3.,  3., -2., -2.);

		SetVertex (vertexList,  3.,  3.,  3., -2.,  3.);

		SetVertex (vertexList,  3.,  3.,  3.,  3., -2.);

		SetVertex (vertexList,  3.,  3.,  3.,  3.,  3.);
