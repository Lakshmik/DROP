...
/**
 * <i>MultidimensionalRosenbrock</i> implements the Combination of N 2D <i>Rosenbrock</i> Problems. The
 * 	References are:
 *
 *  <br>
 *  <ul>
 ...
 *
 *  <ul>
 * 		<li><i>MultidimensionalRosenbrock</i> Constructor</li>
 * 		<li>Retrieve the Underlying <i>Rosenbrock</i> Instance</li>
 * 		<li>Retrieve the Number of 2D <i>Rosenbrock</i> Problems</li>
...
public abstract class MultidimensionalRosenbrock
	extends RdToR1
{
	private int _problemCount = -1;
	private Rosenbrock _rosenbrock = null;

	/**
	 * <i>MultidimensionalRosenbrock</i> Constructor
	 * 
	 * @param rosenbrock Underlying <i>Rosenbrock</i> Instance
	 * @param problemCount Number of 2D <i>Rosenbrock</i> Problems
	 * 
	 * @throws Exception Thrown if the Inputs are Invalid
	 */

	public MultidimensionalRosenbrock (
		...
		throws Exception
	{
		...
		if (null == (_rosenbrock = rosenbrock) || 0 >= (_problemCount = problemCount)) {
			throw new Exception ("MultidimensionalRosenbrock Constructor => Invalid Inputs");
		}
	}

	/**
	 * Retrieve the Underlying <i>Rosenbrock</i> Instance
	 * 
	 * @return Underlying <i>Rosenbrock</i> Instance
	 */
	...
	/**
	 * Retrieve the Number of 2D <i>Rosenbrock</i> Problems
	 * 
	 * @return Number of 2D <i>Rosenbrock</i> Problems
	 */
