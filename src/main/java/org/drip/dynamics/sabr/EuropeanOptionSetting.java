...
/**
 * <i>EuropeanOptionSetting</i> holds the Strike/TTE of a European Option. The References are:
 *  
 * <br><br>
 *  <ul>
 *  	<li>
 ...
 *
 *  <ul>
 * 		<li><i>EuropeanOptionSetting</i> Constructor</li>
 * 		<li>Retrieve the Option Strike</li>
 * 		<li>Retrieve the Option Time-to-expiry</li>
 *	</ul>
 *
...
public class EuropeanOptionSetting
{
	private double _tte = Double.NaN;
	private double _strike = Double.NaN;

	/**
	 * <i>EuropeanOptionSetting</i> Constructor
	 * 
	 * @param strike Strike
	 * @param tte Time-to-expiry
	 * 
	 * @throws Exception Thrown if the Inputs are Invalid
	 */

	public EuropeanOptionSetting (
		final double strike,
		final double tte)
		throws Exception
	{
		if (!NumberUtil.IsValid (_strike = strike) ||
			!NumberUtil.IsValid (_tte = tte) || 0. >= _tte)
		{
			throw new Exception ("EuropeanOptionSetting Constructor => Invalid Inputs");
		}
	}
	...
	/**
	 * Retrieve the Option Time-to-expiry
	 * 
	 * @return Option Time-to-expiry
	 */
