...
public class BilateralCSAZeroThresholdFundingStochastic
{
		...
		throws Exception
	{
		...
		int maturityStepCount = (int) (timeToMaturity / timeWidth);
		...
		throws Exception
	{
		...
		double bankSubordinateFundingSpreadDrift = 0.00002;
		double bankSubordinateFundingSpreadVolatility = 0.002;
		...
		JulianDate[] vertexArray = new JulianDate[stepCount + 1];
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			for (int stepIndex = 0; stepIndex <= stepCount; ++stepIndex) {
				vertexArray[stepIndex] = spotDate.addMonths (6 * stepIndex + 6);
				...
				marketVertexArray[stepIndex] = MarketVertex.Nodal (
					vertexArray[stepIndex] = spotDate.addMonths (6 * stepIndex),
					...
					new MarketVertexEntity (
						...
						Math.exp (-0.5 * bankHazardRateArray[stepIndex] * (1. - bankSeniorRecoveryRateArray[stepIndex]) * stepCount),
						bankSubordinateRecoveryRateArray[stepIndex],
						bankSubordinateFundingSpreadArray[stepIndex],
							Math.exp (-0.5 * bankHazardRateArray[stepIndex] * (1. - bankSubordinateRecoveryRateArray[stepIndex]) * stepCount)
					),
					new MarketVertexEntity (
						...
						Math.exp (-0.5 * counterPartyHazardRateArray[stepIndex] * (1. - counterPartyRecoveryRateArray[stepIndex]) * stepCount),
						Double.NaN,
						Double.NaN,
						Double.NaN
					),
				...
				if (0 != stepIndex) {
					collateralGroupVertex1Array[stepIndex] = BurgardKjaerBuilder.GoldPlatedTwoWayCSA (
						vertexArray[stepIndex],
					...
					collateralGroupVertex2Array[stepIndex] = BurgardKjaerBuilder.GoldPlatedTwoWayCSA (
						vertexArray[stepIndex],
		...
		throws Exception
	{
		...
		System.out.println (
			"\t|| Average => " + FormatUtil.FormatDouble (
				ucolvaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  |  " + FormatUtil.FormatDouble (
				ftdcolvaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				ucvaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				ftdcvaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				cvaclUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				cvaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				dvaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fvaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fdaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fcaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fbaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				sfvaUnivariateDiscreteThin.average(),
				2,
				2,
				1.
			) + "  ||"
		...
		System.out.println (
			"\t|| Minimum => " + FormatUtil.FormatDouble (
				ucolvaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  |  " + FormatUtil.FormatDouble (
				ftdcolvaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				ucvaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				ftdcvaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				cvaclUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				cvaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				dvaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fvaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fdaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fcaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fbaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  | " +  FormatUtil.FormatDouble (
				sfvaUnivariateDiscreteThin.minimum(),
				2,
				2,
				1.
			) + "  ||"
		...
		System.out.println (
			"\t|| Maximum => " + FormatUtil.FormatDouble (
				ucolvaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  |  " + FormatUtil.FormatDouble (
				ftdcolvaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				ucvaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				ftdcvaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				cvaclUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				cvaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				dvaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fvaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fdaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fcaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fbaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				sfvaUnivariateDiscreteThin.maximum(),
				2,
				2,
				1.
			) + "  ||"
		...
		System.out.println (
			"\t||  Error  => " + FormatUtil.FormatDouble (
				ucolvaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  |  " + FormatUtil.FormatDouble (
				ftdcolvaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				ucvaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				ftdcvaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				cvaclUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				cvaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				dvaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fvaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fdaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fcaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " + FormatUtil.FormatDouble (
				fbaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  | " +  FormatUtil.FormatDouble (
				sfvaUnivariateDiscreteThin.error(),
				2,
				2,
				1.
			) + "  ||"
		...
		throws Exception
	{
		...
		System.out.println (
			"\t|| Average => " + FormatUtil.FormatDouble (
				...
				expandedExposureAdjustmentDigest.fva().average() - groundExposureAdjustmentDigest.fva().average(),
				3,
				1,
				10000.
			) + "  | " + FormatUtil.FormatDouble (
				expandedExposureAdjustmentDigest.fda().average() - groundExposureAdjustmentDigest.fda().average(),
				3,
				1,
				10000.
			) + "  | " + FormatUtil.FormatDouble (
				expandedExposureAdjustmentDigest.fca().average() - groundExposureAdjustmentDigest.fca().average(),
				3,
				1,
				10000.
			) + "  | " + FormatUtil.FormatDouble (
				expandedExposureAdjustmentDigest.fba().average() - groundExposureAdjustmentDigest.fba().average(),
				3,
				1,
				10000.
			) + "  | " + FormatUtil.FormatDouble (
				expandedExposureAdjustmentDigest.sfva().average() - groundExposureAdjustmentDigest.sfva().average(),
				3,
				1,
				10000.
			) + "  ||"
