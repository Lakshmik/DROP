 ...
 *
 *  <ul>
 * 		<li><i>HaganKumarLesniewskiWoodward2002</i> Constructor</li>
 * 		<li>Retrieve the <i>ForwardProcessSetting</i> Instance</li>
 * 		<li>Retrieve the <i>EuropeanOptionSetting</i> Instance</li>
 * 		<li>Indicate whether the Implication is based on Normal/Log-normal Scheme</li>
 * 		<li>Indicate if the Mid is Arithmetic/Geometric</li>
 * 		<li>Imply the Volatility using the Mid-Price and the SABR Dynamics Implication Schemes</li>
 *	</ul>
 *
