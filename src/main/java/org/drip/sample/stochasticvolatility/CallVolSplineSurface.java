...
public class CallVolSplineSurface
{
		...
		throws Exception
	{
		...
		MarketSurface cubicPolynomialPriceSurface = ScenarioMarketSurfaceBuilder.HestonRunMarketSurface (
		...
		MarketSurface klkHyperbolicPriceSurface = ScenarioMarketSurfaceBuilder.HestonRunMarketSurface (
