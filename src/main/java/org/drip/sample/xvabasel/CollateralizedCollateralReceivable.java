...
public class CollateralizedCollateralReceivable
{
		...
		throws Exception
	{
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			AlbaneseAndersen[] albaneseAndersen1 = new AlbaneseAndersen[stepCount + 1];
			AlbaneseAndersen[] albaneseAndersen2 = new AlbaneseAndersen[stepCount + 1];
			...
			for (int stepIndex = 0; stepIndex <= stepCount; ++stepIndex) {
				...
				albaneseAndersen1[stepIndex] = new AlbaneseAndersen (
				...
				albaneseAndersen2[stepIndex] = new AlbaneseAndersen (
					vertexDateArray[stepIndex],
			...
			CollateralGroupPath[] groundCollateralGroupPathArray = new CollateralGroupPath[] {
				new CollateralGroupPath (albaneseAndersen1, marketPath)
			};

			CollateralGroupPath[] extendedCollateralGroupPathArray = new CollateralGroupPath[] {
				new CollateralGroupPath (albaneseAndersen1, marketPath),
				new CollateralGroupPath (albaneseAndersen2, marketPath)
			};
