...
public class SemiReplicationZeroThresholdFunding
{
		...
		throws Exception
	{
		...
		MonoPathExposureAdjustment[] groundMonoPathExposureAdjustment =
			new MonoPathExposureAdjustment[pathCount];
		MonoPathExposureAdjustment[] extendedMonoPathExposureAdjustment =
			new MonoPathExposureAdjustment[pathCount];
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			groundMonoPathExposureAdjustment[pathIndex] = new MonoPathExposureAdjustment (
			...
			extendedMonoPathExposureAdjustment[pathIndex] = new MonoPathExposureAdjustment (
				new AlbaneseAndersenFundingGroupPath[] {
					new AlbaneseAndersenFundingGroupPath (
						new AlbaneseAndersenNettingGroupPath[] {
							new AlbaneseAndersenNettingGroupPath (collateralGroupPath1Array, marketPath),
		...
		return new ExposureAdjustmentAggregator[] {
			new ExposureAdjustmentAggregator (groundMonoPathExposureAdjustment),
			new ExposureAdjustmentAggregator (extendedMonoPathExposureAdjustment)
		};
	}
		...
		throws Exception
	{
		...
		ExposureAdjustmentAggregator[] exposureAdjustmentAggregatorAerray = Mix (5., 0., 100., 5., 0., 1.);

		ExposureAdjustmentAggregator extendedExposureAdjustmentAggregator =
			exposureAdjustmentAggregatorAerray[1];
		ExposureAdjustmentAggregator groundExposureAdjustmentAggregator =
			exposureAdjustmentAggregatorAerray[0];
