 ...
 * [***MultivariateDiscrete***](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/measure/statistics/MultivariateDiscrete.java)
 <i>MultivariateDiscrete</i> analyzes and computes the Moment and Metric Statistics for the Realized
 Multivariate Sequence.

 * [***MultivariateMoments***](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/measure/statistics/MultivariateMoments.java)
