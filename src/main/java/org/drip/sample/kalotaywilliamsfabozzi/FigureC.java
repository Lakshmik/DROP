...
/**
 * <i>FigureC</i> reconciles the Output of Figure C in Kalotay, Williams, and Fabozzi (1993). The References
 * 	are:
 *  
 * 	<br>
 *  <ul>
...
public class FigureC
{
	...
	private static final TreeMap<Double, Double> TimeToProjectedBaseForwardYieldMapInput()
	{
		...
		timeToProjectedBaseForwardYieldMapInput.put (2., 0.045);
	...
	private static final Map<Double, List<Double>> TimeToProjectedForwardYieldListMapReconciler()
	{
		...
		projected1YForwardYieldList.add (0.04500);

		projected1YForwardYieldList.add (0.05496);
	...
	private static final Map<Double, List<Double>> ProjectedBulletBondValueListMapReconciler()
	{
		...
		projected1YBulletBondValueList.add (99.567);

		projectedBulletBondValueListMap.put (0., projected1YBulletBondValueList);

		List<Double> projected2YBulletBondValueList = new ArrayList<Double>();

		projected2YBulletBondValueList.add (99.522);

		projected2YBulletBondValueList.add (98.582);

		projectedBulletBondValueListMap.put (1., projected2YBulletBondValueList);
		...
		throws Exception
	{
		...
		System.out.println ("\t| Kalotay, Williams, and Fabozzi (1993) Figure C||");
