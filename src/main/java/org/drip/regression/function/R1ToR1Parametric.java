...
/**
 * <i>R1ToR1Parametric</i> abstracts the Calibratable R<sup>1</sup> to R<sup>1</sup> Function. The References
 *  are:
 *
 *  <br><br>
 *  <ul>
...
public abstract class R1ToR1Parametric
{

	protected abstract R1ToR1 objectiveFunction (
	...
	public double objectiveFunctionValue (
		...
		throws Exception
	{
		R1ToR1 objectiveFunction = objectiveFunction (parameterArray);

		if (null == objectiveFunction) {
			throw new Exception ("R1ToR1Parametric::objectiveFunctionValue => Invalid Inputs");
		}
	...
	public abstract double[] parameterJacobian (
		final double[] parameterArray,
		final double x
	);
	...
	public abstract double[][] parameterHessian (
		final double[] parameterArray,
		final double x
	);
