...
public class DU1KeyRateDuration
{
		...
		throws Exception
	{
		...
		String treasuryMarkLocation = "C:\\DROP\\Daemons\\Transforms\\TreasuryYieldMarks\\" +
			TreasurySettingContainer.CurrencyBenchmarkCode (TreasurySettingContainer.TreasurySetting (
				treasuryCode
			).currency()) + "BenchmarksReconstituted.csv";
		...
		for (TenorDurationNodeMetrics tenorDurationNodeMetrics : tenorDurationNodeMetricsList) {
			...
			{
				tenorDurationNodeMetricsDump += "," + FormatUtil.FormatDouble (
					tenorDurationNodeMetricsEntry.getValue(),
					1,
					4,
					1.
				);
