...
public class UncollateralizedFundingReceivableStochastic
{
		...
		throws Exception
	{
		...
		MonoPathExposureAdjustment[] aCPGPGround = new MonoPathExposureAdjustment[pathCount];
		MonoPathExposureAdjustment[] aCPGPExtended = new MonoPathExposureAdjustment[pathCount];
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			aCPGPGround[pathIndex] = new MonoPathExposureAdjustment (
			...
			aCPGPExtended[pathIndex] = new MonoPathExposureAdjustment (
				new AlbaneseAndersenFundingGroupPath[] {
					new AlbaneseAndersenFundingGroupPath (
						new AlbaneseAndersenNettingGroupPath[] {
							new AlbaneseAndersenNettingGroupPath (collateralGroupPath1Array, marketPath),
