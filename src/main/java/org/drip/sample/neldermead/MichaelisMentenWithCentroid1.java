...
/**
 * <i>MichaelisMentenWithCentroid1</i> illustrates the Optimization of the Michaelis Menten Function using
 * 	the Nelder-Mead Scheme that incorporates in Variate Selection. The Range is [0.25-0.75, 0.25-0.75]. The
 *  References are:
 *
 *  <br>
 *  <ul>
...
public class MichaelisMentenWithCentroid1
{
		...
		throws Exception
	{
		...
		double sLeft = 0.25;
		double sRight = 0.75;
		double rateLeft = 0.25;
		double rateRight = 0.75;
