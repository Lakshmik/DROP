...
/**
 * <i>Rosenbrock</i> implements the Multi-modal Rosenbrock Function. The References are:
 *
 *  <br>
 *  <ul>
 *  	<li>
 ...
 *
 *  <ul>
 * 		<li>Construct a Standard Instance of <i>Rosenbrock</i></li>
 * 		<li><i>Rosenbrock</i> Constructor</li>
 * 		<li>Retrieve the Rosenbrock "A"</li>
 * 		<li>Retrieve the Rosenbrock "B"</li>
	...
	implements R2ToR1
{
	...
	/**
	 * Construct a Standard Instance of <i>Rosenbrock</i>
	 * 
	 * @return Standard Instance of <i>Rosenbrock</i>
	 */

	public static final Rosenbrock Standard()
	{
		try {
			return new Rosenbrock (1., 100.);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/**
	 * <i>Rosenbrock</i> Constructor
	 * 
	 * @param a Rosenbrock "A"
	 * @param b Rosenbrock "B"
	 * 
	...
	public Rosenbrock (
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (_a = a) || !NumberUtil.IsValid (_b = b)) {
			throw new Exception ("Rosenbrock Constructor => Invalid Inputs");
		}
	}

	/**
	 * Retrieve the Rosenbrock "A"
	 * 
	 * @return Rosenbrock "A"
	 */
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (x) || !NumberUtil.IsValid (y)) {
			throw new Exception ("Rosenbrock::evaluate => Invalid Inputs");
		}

		double f1 = _a - x;
		double f2 = y - x * x;
		return f1 * f1 + _b * f2 * f2;
	}
}
