...
public class MultiCurveFRAStandardAnalysis
{
		...
		throws Exception
	{
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (fraMeasureMap.get ("ParForward"), 1, 4, 100.) + "% |" +
			FormatUtil.FormatDouble (fraMeasureMap.get ("QuantoAdjustedParForward"), 1, 4, 100.) + "% |" +
			FormatUtil.FormatDouble (fraMeasureMap.get ("MultiplicativeQuantoAdjustment"), 1, 4, 1.) + " | "
			+ FormatUtil.FormatDouble (fraMeasureMap.get ("AdditiveQuantoAdjustment"), 1, 1, 10000.)
		);
	}
		...
		throws Exception
	{
		...
		ValuationParams valParams = new ValuationParams (today, today, currency);
