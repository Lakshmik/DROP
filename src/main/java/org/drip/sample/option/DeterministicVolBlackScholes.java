...
public class DeterministicVolBlackScholes
{
		...
		throws Exception
	{
		...
		SABRLIBORCapVolatility sabrLIBORCapVolatility = new SABRLIBORCapVolatility (
			today.julian(),
			0.2000,				// A
			0.0005 / 365.25, 	// B
			0.1000 / 365.25, 	// C
		...
		for (Map.Entry<String, Double> mapEntry : optionMeasuresMap.entrySet()) {
		...
		System.out.println (
			"\t|| Implied Volatility From Put Price  :" + FormatUtil.FormatDouble (
				option.implyVolatilityFromPutPrice (
					...
					false,
					discountCurve,
					optionMeasuresMap.get ("PutPrice")
				),
				2,
				2,
				100.
