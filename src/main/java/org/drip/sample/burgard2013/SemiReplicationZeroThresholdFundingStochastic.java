...
public class SemiReplicationZeroThresholdFundingStochastic
{
		...
		throws Exception
	{
		...
		JumpDiffusionEdge[] aJDE = numeraireValueDiffusionEvolver.incrementSequence (
		...
		for (int stepIndex = 1; stepIndex <= stepCount; ++stepIndex) {
			numeraireValueArray[stepIndex] = aJDE[stepIndex - 1].finish();
		}
		...
		throws Exception
	{
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			double dblValueStart1 = time * initialATMSwapRateOffset1;
			double dblValueStart2 = time * initialATMSwapRateOffset2;
			...
			for (int stepIndex = 0; stepIndex <= stepCount; ++stepIndex) {
				...
				double endValue1 = portfolio1ValueGrid[pathIndex][stepIndex];
				double endValue2 = portfolio2ValueGrid[pathIndex][stepIndex];
