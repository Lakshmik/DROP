...
/**
 * <i>FigureD2</i> illustrates the Calibration and Reconciliation of Figure D in Kalotay, Williams, and
...
public class FigureD2
{
	...
	{
		Map<Double, List<Double>> timeToProjectedBulletBondValueListMap =
			new TreeMap<Double, List<Double>>();
		...
		timeToProjectedBulletBondValueListMap.put (0., projected1YBulletBondValueList);

		List<Double> projected2YBulletBondValueList = new ArrayList<Double>();

		projected2YBulletBondValueList.add (99.929);

		projected2YBulletBondValueList.add (99.071);

		timeToProjectedBulletBondValueListMap.put (1., projected2YBulletBondValueList);

		return timeToProjectedBulletBondValueListMap;
	}
		...
		throws Exception
	{
		...
		double bondCoupon = 0.04;
		double bondMaturityTime = 2.;
		double calibrationPrice = 1.;
		double calibrationEndTime = 2.;
		double annualizedForwardVolatility = 0.1;
		double projectedBaseBulletForwardYieldReconciler = 0.04074;
		...
		double calibratedBaseBulletYield = new ProxyBondPriceFunction (
		...
		System.out.println ("\t| Kalotay, Williams, and Fabozzi (1993) Figure D2 ||");
		...
		System.out.println (
			"\t| Calibration Base Yield (Reconciler) => " +
				FormatUtil.FormatDouble (calibratedBaseBulletYield, 1, 3, 100., false) + "% (" +
				FormatUtil.FormatDouble (projectedBaseBulletForwardYieldReconciler, 1, 3, 100., false) + "%)"
		);

		System.out.println ("\t|-------------------------------------------------||\n");

		projectedBaseForwardYieldMap.put (calibrationEndTime, calibratedBaseBulletYield);
