...
public class StaticContinuousOptimalTrajectory
{
		...
		throws Exception
	{
		...
		EfficientTradingTrajectoryContinuous staticContinuousEfficientTradingTrajectoryContinuous =
		...
		R1ToR1 staticContinuousHoldingsFunction =
			staticContinuousEfficientTradingTrajectoryContinuous.holdings();

		R1ToR1 staticContinuousTradeRateFunction =
			staticContinuousEfficientTradingTrajectoryContinuous.tradeRate();

		R1ToR1 staticContinuousTransactionCostVarianceFunction =
			staticContinuousEfficientTradingTrajectoryContinuous.transactionCostVarianceFunction();

		R1ToR1 staticContinuousTransactionCostExpectationFunction =
			staticContinuousEfficientTradingTrajectoryContinuous.transactionCostExpectationFunction();
		...
		for (int timeIndex = 1; timeIndex <= n; ++timeIndex) {
			...
			System.out.println (
				"\t|" + FormatUtil.FormatDouble (
					...
					staticContinuousHoldingsFunction.evaluate (time) * inverseX,
					1,
					3,
					1.
				) + " | " + FormatUtil.FormatDouble (
					staticContinuousTradeRateFunction.evaluate (time) * timeWidth * inverseX,
					1,
					3,
					1.
				) + " | " + FormatUtil.FormatDouble (
					staticContinuousTransactionCostExpectationFunction.evaluate (time) * inverseX,
					1,
					3,
					1.
				) + " | " + FormatUtil.FormatDouble (
					Math.sqrt (staticContinuousTransactionCostVarianceFunction.evaluate (time)) * inverseX,
					1,
					3,
					1.
				) + " ||"
