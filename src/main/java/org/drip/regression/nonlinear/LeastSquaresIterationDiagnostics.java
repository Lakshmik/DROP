...
/**
 * <i>LeastSquaresIterationDiagnostics</i> holds the Results of a Least-Squares Iteration Run. The References
 *  are:
 *
 *  <br><br>
 *  <ul>
...
public class LeastSquaresIterationDiagnostics
	extends LeastSquaresRun
{
	private double[][] _hessian = null;
	private double[] _parameterArray = null;
	private double[][] _hessianProxy = null;
	private double[] _residualValueArray = null;
	private double[][] _hessianCorrection = null;
	private double[] _parameterDeltaArray = null;
	private double _sumOfResidualSquares = Double.NaN;

	/**
	 * Retrieve the Array of Parameter Changes
	 * 
	 * @return Array of Parameter Changes
	 */

	public double[] parameterDeltaArray()
	{
		return _parameterDeltaArray;
	}
	...
	{
		if (null == parameterDeltaArray || 0 == parameterDeltaArray.length ||
			!NumberUtil.IsValid (parameterDeltaArray))
		{
			return false;
		}

		_parameterDeltaArray = parameterDeltaArray;
		return true;
	}
	...
	{
		if (null == parameterArray || 0 == parameterArray.length || !NumberUtil.IsValid (parameterArray)) {
			return false;
		}
	...
	{
		return _residualValueArray;
	}

	/**
	 * Set the Array of Residual Values
	 * 
	 * @param residualValueArray Array of the Residual Values
	 * 
	 * @return TRUE - The Array of Residual Values Successfully Set
	 */

	public boolean setResidualValueArray (
		final double[] residualValueArray)
	{
		if (null == residualValueArray || 0 == residualValueArray.length ||
			!NumberUtil.IsValid (residualValueArray))
		{
			return false;
		}

		_residualValueArray = residualValueArray;
		return true;
	}
	...
	public double sumOfResidualSquares()
	{
		return _sumOfResidualSquares;
	}
	...
	{
		if (!NumberUtil.IsValid (sumOfResidualSquares) || 0. > sumOfResidualSquares) {
			return false;
		}

		_sumOfResidualSquares = sumOfResidualSquares;
		return true;
	}

	/**
	 * Retrieve the Hessian Proxy
	 * 
	 * @return Hessian Proxy
	 */
	...
	/**
	 * Set the Hessian Proxy
	 * 
	 * @param hessianProxy Hessian Proxy
	 * 
	 * @return TRUE - Hessian Proxy Successfully Set
	 */

	public boolean setHessianProxy (
		final double[][] hessianProxy)
	{
		if (null == hessianProxy) {
			return false;
		}

		_hessianProxy = hessianProxy;
		return true;
	}
	 ...
	 * 
	 * @return TRUE - Hessian Successfully Set
	 */

	public boolean setHessian (
	...
	/**
	 * Retrieve the Hessian Correction
	 * 
	...
	{
		return _hessianCorrection;
	}

	/**
	 * Set the Hessian Correction
	 * 
	 * @param hessianCorrection Hessian Correction
	 * 
	 * @return TRUE - Hessian Correction Successfully Set
	 */

	public boolean setHessianCorrection (
		final double[][] hessianCorrection)
	{
		if (null == hessianCorrection) {
			return false;
		}

		_hessianCorrection = hessianCorrection;
		return true;
	}
	...
	public String toString (
		final String prefix)
	{
		return prefix + "Iteration Diagnostics => {" +
			" Parameter Delta Array: " + NumberUtil.ArrayRow (_parameterDeltaArray, 1, 6, false) +
			"; Parameter Array: " + NumberUtil.ArrayRow (_parameterArray, 1, 4, false) +
			"; Residual Value Array: " + NumberUtil.ArrayRow (_residualValueArray, 1, 6, false) +
			"; Sum Of Residual Squares: " + FormatUtil.FormatDouble (_sumOfResidualSquares, 1, 4, 1.) +
			"; Hessian Proxy: " + NumberUtil.MatrixToString ("", _hessianProxy, 1, 6) +
			"; Hessian Correction: " + NumberUtil.MatrixToString ("", _hessianCorrection, 1, 6) +
			"; Hessian: " + NumberUtil.MatrixToString ("", _hessian, 1, 6) +
		"}";
	}
