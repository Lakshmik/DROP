...
/**
 * <i>FXForwardMarkSuite</i> maintains the Instrument Market Quotes used in the FX Forward State
 * 	Construction. It provides the following Functionality:
 *
 *  <ul>
 * 		<li><i>FundingMarkSuite</i> Constructor</li>
 * 		<li>Retrieve the As Of Date</li>
 * 		<li>Retrieve the Array of FX Forward Quotes</li>
 *  </ul>
 *  
 *	<br>
...
public class FXForwardMarkSuite
{
	...
	/**
	 * <i>FXForwardMarkSuite</i> Constructor
	 * 
	 * @param asOfDate As Of Date
	 * @param fxSpot FX Spot
	 * @param quoteArray Array of FX Forward Quotes
	 * 
	 * @throws Exception Thrown if the Inputs are Invalid
	 */

	public FXForwardMarkSuite (
		...
		throws Exception
	{
		if (null == (_asOfDate = asOfDate) ||
			!NumberUtil.IsValid (_fxSpot = fxSpot) ||
			(null == (_quoteArray = quoteArray) || 0 == _quoteArray.length))
		{
			throw new Exception ("FXForwardMarkSuite Constructor => Invalid Inputs");
		}
	}
	...
	/**
	 * Retrieve the Array of FX Forward Quotes
	 * 
	 * @return Array of FX Forward Quotes
	 */

	public double[] quoteArray()
	{
		return _quoteArray;
	}
}
