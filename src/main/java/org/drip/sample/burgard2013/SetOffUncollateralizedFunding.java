...
public class SetOffUncollateralizedFunding
{
		...
		throws Exception
	{
		...
		double[][] aadblCollateralBalance = new double[pathCount][stepCount + 1];
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			for (int stepIndex = 0; stepIndex <= stepCount; ++stepIndex) {
				aadblCollateralBalance[pathIndex][stepIndex] = 0.;
		...
		throws Exception
	{
		...
		ExposureAdjustmentAggregator cpgaExtended = exposureAdjustmentAggregatorArray[1];
		ExposureAdjustmentAggregator cpgaGround = exposureAdjustmentAggregatorArray[0];

		ExposureAdjustmentDigest groundExposureAdjustmentDigest = cpgaGround.digest();

		ExposureAdjustmentDigest extendedExposureAdjustmentDigest = cpgaExtended.digest();
