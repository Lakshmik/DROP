...
public class CollateralizedNettingNeutralStochastic
{
		...
		throws Exception
	{
		...
		OTCAccountingPolicy oapFCAFBA = otcAccountingModusFCAFBA.feePolicy (expandedExposureAdjustmentAggregator);

		OTCAccountingPolicy oapFVAFDA = otcAccountingModusFVAFDA.feePolicy (expandedExposureAdjustmentAggregator);
