...
/**
 * <i>SampleResidualJacobian</i> holds the Gauss Newton "J" Matrix - the Array of Sample Residual Jacobians
 * 	and their Transpose. The References are:
 *
 *  <br><br>
 *  <ul>
 *  	<li>
...
public class SampleResidualJacobian
{
	private double[][] _j = null;
	private double[][] _jTranspose = null;
	private double[][] _jTransposeJ = null;

	/**
	 * <i>SampleResidualJacobian</i> Constructor
	 * 
	 * @param j "J" Matrix
	 * 
	...
	public SampleResidualJacobian (
		final double[][] j)
		throws Exception
	{
		if (null == (
			_jTransposeJ = R1MatrixUtil.Product (_jTranspose = R1MatrixUtil.Transpose (_j = j), _j)
		))
		{
			throw new Exception ("SampleResidualJacobian Constructor => Invalid Inputs");
		}
	}

	/**
	 * Retrieve the "J" Matrix
	 * 
	 * @return "J" Matrix
	 */
	...
	/**
	 * Retrieve the J<sup>T</sup> Matrix
	 * 
	 * @return J<sup>T</sup> Matrix
	 */

	public double[][] jTranspose()
	{
		return _jTranspose;
	}

	/**
	 * Retrieve the J<sup>T</sup>J Matrix
	 * 
	 * @return J<sup>T</sup>J Matrix
	 */

	public double[][] jTransposeJ()
	{
		return _jTransposeJ;
	}
}
