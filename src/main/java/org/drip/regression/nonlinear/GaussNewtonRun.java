...
/**
 * <i>GaussNewtonRun</i> holds the Results of a Gauss-Newton Least-Squares Calibration Run. The References
 * 	are:
 *
 *  <br><br>
 *  <ul>
...
public class GaussNewtonRun
{
	...
	public static final GaussNewtonRun Standard (
		final double[] parameterArray,
		final double sumOfResidualSquares)
	{
		GaussNewtonRun calibratedParameters = new GaussNewtonRun();

		return calibratedParameters.setParameterArray (parameterArray) &&
			calibratedParameters.setSumOfResidualSquares (sumOfResidualSquares) ?
			calibratedParameters : null;
	}

	protected GaussNewtonRun()
	{
	}
