...
public class PerfectReplicationZeroThresholdFundingStochastic
{
		...
		throws Exception
	{
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			CollateralGroupPath[] collateralGroupPath1Array1 = new CollateralGroupPath[] {
				new CollateralGroupPath (collateralGroupVertex1Array, marketPath)
			};

			CollateralGroupPath[] collateralGroupPath1Array2 = new CollateralGroupPath[] {
				...
				new AlbaneseAndersenFundingGroupPath[] {
					new AlbaneseAndersenFundingGroupPath (
						new AlbaneseAndersenNettingGroupPath[] {
							new AlbaneseAndersenNettingGroupPath (collateralGroupPath1Array1, marketPath)
						},
						marketPath
					)
				}
			...
			extendedMonoPathExposureAdjustmentArray[pathIndex] = new MonoPathExposureAdjustment (
				new AlbaneseAndersenFundingGroupPath[] {
					new AlbaneseAndersenFundingGroupPath (
						new AlbaneseAndersenNettingGroupPath[] {
							new AlbaneseAndersenNettingGroupPath (collateralGroupPath1Array1, marketPath),
							new AlbaneseAndersenNettingGroupPath (collateralGroupPath1Array2, marketPath)
						},
						marketPath
					)
				}
