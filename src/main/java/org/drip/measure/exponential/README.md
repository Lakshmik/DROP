# DROP Measure Exponential Package

<p align="center"><img src="https://github.com/lakshmik/DROP/blob/master/DRIP_Logo.gif?raw=true" width="100"></p>

DROP Measure Exponential holds R<sup>1</sup> Exponential Distribution Implementation/Properties.


## Class Components

 * [***IIDComposite***](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/measure/exponential/IIDComposite.java)
 <i>IIDComposite</i> generates Metrics for a Composite Set of i.i.d. R<sup>1</sup> Exponential Distributions.

 * [***PoissonDistribution***](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/measure/exponential/PoissonDistribution.java)
 <i>PoissonDistribution</i> implements the Univariate Poisson Distribution using the specified Mean/Variance.

 * [***R1RateDistribution***](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/measure/exponential/R1RateDistribution.java)
 <i>R1RateDistribution</i> implements the Rate Parameterization of the R<sup>1</sup> Exponential Distribution.

 * [***R1ScaledDistribution***](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/measure/exponential/R1ScaledDistribution.java)
 <i>R1ScaledDistribution</i> implements the Probability Density Function for the Scaled R<sup>1</sup> Exponential Function.

 * [***RealizedMinimaR1RateDistribution***](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/measure/exponential/RealizedMinimaR1RateDistribution.java)
 <i>RealizedMinimaR1RateDistribution</i> implements the Rate Parameterization of the Realized Minimum among the Set of R<sup>1</sup> Exponential Distributions.

 * [***TwoIIDSum***](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/measure/exponential/TwoIIDSum.java)
 <i>TwoIIDSum</i> implements the PDF of the Sum of Two IID Exponential Random Variables.
