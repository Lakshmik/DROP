...
public class TimeRdVertex
{
	...
	public TimeRdVertex (
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (_t = t) ||
			null == (_xArray = xArray) || 0 == _xArray.length || !NumberUtil.IsValid (_xArray))
		{
			throw new Exception ("TimeRdVertex Constructor => Invalid Inputs");
		}
	}
