...
public class SemiReplicationUncollateralizedFunding
{
		...
		throws Exception
	{
		...
		ExposureAdjustmentDigest cpgdGround = groundExposureAdjustmentAggregator.digest();

		ExposureAdjustmentDigest cpgdExtended = extendedExposureAdjustmentAggregator.digest();
