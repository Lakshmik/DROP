...
import org.drip.function.rdtor1.MultidimensionalRosenbrockUncoupled;
...
/**
 * <i>MultidimensionalUncoupledRosenbrockFunction</i> illustrates the Construction and Usage of the
 * 	Multidimensional Uncoupled 2D Rosenbrock Function. The References are:
 *
 *  <br>
 *  <ul>
 *  	<li>
...
public class MultidimensionalUncoupledRosenbrockFunction
{
		...
		throws Exception
	{
		...
		double[] variateStartArray = new double[] {
			variateBegin,
			variateBegin,
			variateBegin,
			variateBegin
		...
		MultidimensionalRosenbrockUncoupled multidimensionalRosenbrockUncoupled =
			new MultidimensionalRosenbrockUncoupled (Rosenbrock.Standard(), variateStartArray.length);

		System.out.println ("\t||----------------------------||");

		System.out.println ("\t||  R^d Rosenbrock Uncoupled  ||");

		System.out.println ("\t||----------------------------||");

		double[] variateArray = variateStartArray;

		Evaluate (multidimensionalRosenbrockUncoupled, variateArray, 0, 0);
