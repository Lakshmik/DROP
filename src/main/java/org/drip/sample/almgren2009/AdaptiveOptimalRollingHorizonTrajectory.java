...
public class AdaptiveOptimalRollingHorizonTrajectory
{
		...
		throws Exception
	{
		...
		CoordinatedVariationRollingHorizon coordinatedVariationRollingHorizon =
			new CoordinatedVariationTrajectoryGenerator (
				...
				OrnsteinUhlenbeckSequence.Systemic (
		...
		double[] nonDimensionalTradeRateArray = coordinatedVariationRollingHorizon.nonDimensionalTradeRate();

		double[] nonDimensionalHoldingsArray = coordinatedVariationRollingHorizon.nonDimensionalHoldings();

		double[] nonDimensionalCostArray = coordinatedVariationRollingHorizon.nonDimensionalCost();
		...
		CoordinatedVariationTrajectoryDeterminant coordinatedVariationTrajectoryDeterminant =
			coordinatedVariationRollingHorizon.determinant();
