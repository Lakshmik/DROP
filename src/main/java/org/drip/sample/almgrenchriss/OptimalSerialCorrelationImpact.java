		...
		throws Exception
	{
		...
		LinearPermanentExpectationParameters linearPermanentExpectationParameters =
			ArithmeticPriceEvolutionParametersBuilder.LinearExpectation (
				new ArithmeticPriceDynamicsSettings (0., new Flat (sigma), serialCorrelation),
		...
		OptimalSerialCorrelationAdjustment[] optimalSerialCorrelationAdjustmentArray =
			new TrajectoryShortfallEstimator (
				almgrenChrissDiscrete
			).serialCorrelationAdjustment (
				linearPermanentExpectationParameters
			);
		...
		for (int executionTimeIndex = 0; executionTimeIndex <= n; ++executionTimeIndex) {
			System.out.println (
				"\t|" + FormatUtil.FormatDouble (
					...
					optimalSerialCorrelationAdjustmentArray[executionTimeIndex].holdingsShift(),
					5,
					1,
					1.
				) + " | " + FormatUtil.FormatDouble (
					optimalSerialCorrelationAdjustmentArray[executionTimeIndex].gain(),
					3,
					1,
					1.
				) + " ||"
