...
public class ForeignCollateralDomesticForex
{
		...
		throws Exception
	{
		...
		double collateralizedFXRate = 1.01;
		double foreignCollateralRate = 0.02;
		double foreignRatesVolatility = 0.3;
		double fxForeignRatesCorrelation = 0.2;
		...
		for (Map.Entry<String, Double> mapEntry :
