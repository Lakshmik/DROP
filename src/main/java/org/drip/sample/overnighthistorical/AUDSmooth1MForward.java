 ...
 *		<tr><td><b>Package</b></td> <td><a href = "https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/sample/overnighthistorical/README.md">G7 Smooth OIS 1M Forward</a></td></tr>
 *  </table>
 *	<br>
 * 
...
public class AUDSmooth1MForward
{
		...
		throws Exception
	{
		...
		for (String inTeno : inTenorArray) {
			for (String forTenor : forTenorArray) {
				dump += "," + inTeno + forTenor;
			}
		}
		...
		for (int closeDateIndex = 0; closeDateIndex < closeDateCount; ++closeDateIndex) {
			FundingCurveMetrics fcm = fundingCurveMetricsMap.get (spotDateArray[closeDateIndex]);
			...
			for (String inTenor : inTenorArray) {
				for (String forTenor : forTenorArray) {
					dump += "," + FormatUtil.FormatDouble (
						fcm.nativeForwardRate (inTenor, forTenor),
						1,
						5,
						100.
					);
