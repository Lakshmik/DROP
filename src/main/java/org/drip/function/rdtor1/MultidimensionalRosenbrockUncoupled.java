...
/**
 * <i>MultidimensionalRosenbrockUncoupled</i> implements the Sum of N/2 Uncoupled 2D <i>Rosenbrock</i>
 ...
 *
 *  <ul>
 * 		<li>Construct a Standard Instance of <i>MultidimensionalRosenbrockUncoupled</i></li>
 * 		<li><i>MultidimensionalRosenbrockUncoupled</i> Constructor</li>
...
public class MultidimensionalRosenbrockUncoupled
	extends MultidimensionalRosenbrock
{

	/**
	 * Construct a Standard Instance of <i>MultidimensionalRosenbrockUncoupled</i>
	 * 
	 * @param problemCount Number of Uncoupled 2D <i>Rosenbrock</i> Problems
	 * 
	 * @return Standard Instance of <i>MultidimensionalRosenbrockUncoupled</i>
	 */

	public static MultidimensionalRosenbrockUncoupled Standard (
		final int problemCount)
	{
		try {
			return new MultidimensionalRosenbrockUncoupled (Rosenbrock.Standard(), problemCount);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/**
	 * <i>MultidimensionalRosenbrockUncoupled</i> Constructor
	 * 
	...
	public MultidimensionalRosenbrockUncoupled (
		...
		throws Exception
	{
		...
		if (0 != (problemCount % 2)) {
			throw new Exception ("MultidimensionalRosenbrock Constructor => Invalid Inputs");
		}
	}
		...
		throws Exception
	{
		...
		{
			throw new Exception ("MultidimensionalRosenbrockUncoupled::evaluate => Invalid Inputs");
		}
		...
		for (int i = 1; i < variateArray.length / 2; ++i) {
			double variate2IMinus1 = variateArray[2 * i - 1];
			double f1 = variate2IMinus1 * variate2IMinus1 - variateArray[2 * i];
			double f2 = variate2IMinus1 - 1.;
