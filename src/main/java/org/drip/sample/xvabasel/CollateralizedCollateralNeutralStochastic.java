...
public class CollateralizedCollateralNeutralStochastic
{
		...
		throws Exception
	{
		...
		for (int pathIndex = 0; pathIndex < pathCount; ++pathIndex) {
			...
			AlbaneseAndersen[] albaneseAndersenArray1 = new AlbaneseAndersen[stepCount + 1];
			AlbaneseAndersen[] albaneseAndersenArray2 = new AlbaneseAndersen[stepCount + 1];
			...
			for (int stepIndex = 0; stepIndex <= stepCount; ++stepIndex) {
				...
				albaneseAndersenArray1[stepIndex] = new AlbaneseAndersen (
				...
				albaneseAndersenArray2[stepIndex] = new AlbaneseAndersen (
					vertexDateArray[stepIndex],
			...
			CollateralGroupPath[] groundCollateralGroupPathArray = new CollateralGroupPath[] {
				new CollateralGroupPath (albaneseAndersenArray1, marketPath)
			};

			CollateralGroupPath[] extendedCollateralGroupPathArray = new CollateralGroupPath[] {
				new CollateralGroupPath (albaneseAndersenArray1, marketPath),
				new CollateralGroupPath (albaneseAndersenArray2, marketPath)
			};
