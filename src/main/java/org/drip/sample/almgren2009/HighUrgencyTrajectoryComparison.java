...
public class HighUrgencyTrajectoryComparison
{
		...
		throws Exception
	{
		...
		EfficientTradingTrajectoryContinuous efficientTradingTrajectoryContinuousAC2012 =
		...
		R1ToR1 holdingsFunctionAC2012 = efficientTradingTrajectoryContinuousAC2012.holdings();

		R1ToR1 tradeRateFunctionAC2012 = efficientTradingTrajectoryContinuousAC2012.tradeRate();

		R1ToR1 transactionCostExpectationFunctionAC2012 =
			efficientTradingTrajectoryContinuousAC2012.transactionCostExpectationFunction();

		EfficientTradingTrajectoryContinuous efficientTradingTrajectoryContinuousHighUrgencyAsymptote =
			(EfficientTradingTrajectoryContinuous) ContinuousHighUrgencyAsymptote.Standard (
				x,
				t,
				linearPermanentExpectationParameters,
				lambdaU
		...
		R1ToR1 highUrgencyAsymptoteHoldingsFunction =
			efficientTradingTrajectoryContinuousHighUrgencyAsymptote.holdings();

		R1ToR1 highUrgencyAsymptoteTradeRateFunction =
			efficientTradingTrajectoryContinuousHighUrgencyAsymptote.tradeRate();

		R1ToR1 highUrgencyAsymptoteTransactionCostExpectationFunction =
			efficientTradingTrajectoryContinuousHighUrgencyAsymptote.transactionCostExpectationFunction();
		...
		for (int timeIndex = 1; timeIndex <= n; ++timeIndex) {
			...
			System.out.println (
				"\t|" + FormatUtil.FormatDouble (
					...
					holdingsFunctionAC2012.evaluate (time) * inverseX,
					1,
					3,
					1.
				) + " | " + FormatUtil.FormatDouble (
					tradeRateFunctionAC2012.evaluate (time) * timeWidth * inverseX,
					1,
					3,
					1.
				) + " | " + FormatUtil.FormatDouble (
					transactionCostExpectationFunctionAC2012.evaluate (time) * inverseX,
					1,
					3,
					1.
				) + " | " + FormatUtil.FormatDouble (
					highUrgencyAsymptoteHoldingsFunction.evaluate (time) * inverseX,
					1,
					3,
					1.
				) + " | " + FormatUtil.FormatDouble (
					highUrgencyAsymptoteTradeRateFunction.evaluate (time) * timeWidth * inverseX,
					1,
					3,
					1.
				) + " | " + FormatUtil.FormatDouble (
					highUrgencyAsymptoteTransactionCostExpectationFunction.evaluate (time) * inverseX,
					1,
					3,
					1.
				) + " ||"
