...
## Documentation
 ...
 |        Document         | Link |
 |-------------------------|------|
 | Technical Specification | [*Latest*](https://github.com/lakshmik/DROP/blob/master/Docs/Internal/PhoneticsAnalytics/PhoneticsAnalytics_v5.67.pdf) [*Previous*](https://github.com/lakshmik/DROP/blob/master/Docs/Internal/PhoneticsAnalytics) |
 | User Guide              |  |
 ...
 * *Phonetics* => Characteristics of Phones, Phonemes, and other Suprasegmental Features.
	* { [**Home**](https://github.com/lakshmik/DROP/tree/master/src/main/java/org/drip/phonetics/README.md) | 
	[**Project**](https://github.com/lakshmik/DROP/issues?q=is%3Aopen+is%3Aissue+label%3Aphonetics) }
