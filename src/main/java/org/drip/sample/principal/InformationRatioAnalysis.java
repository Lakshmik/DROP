...
public class InformationRatioAnalysis
{
		...
		throws Exception
	{
		...
		System.out.println (
			"\t|             OPTIMAL MEASURES INFORMATION RATIO DEPENDENCE               ||"
		);
		...
		System.out.println (
			"\t|            - Gross Returns Standard Deviation                           ||"
		);
		...
		for (double informationRatio : informationRatioArray) {
			double principalDiscount = almgren2003Estimator.principalDiscountHurdle (informationRatio);

			System.out.println (
				"\t|" + FormatUtil.FormatDouble (informationRatio, 1, 2, 1.) + " |" +
				FormatUtil.FormatDouble (principalDiscount, 1, 2, 1.) + " |" + FormatUtil.FormatDouble (
					almgren2003Estimator.principalMeasure (principalDiscount).mean(),
					5,
					0,
					1.
				) + " |" + FormatUtil.FormatDouble (
					Math.sqrt (almgren2003Estimator.principalMeasure (principalDiscount).variance()),
					6,
					0,
					1.
				) + " |" + FormatUtil.FormatDouble (
					...
					Math.sqrt (almgren2003Estimator.horizonPrincipalMeasure (principalDiscount).variance()),
					5,
					0,
					1.
				) + " |" + FormatUtil.FormatDouble (
